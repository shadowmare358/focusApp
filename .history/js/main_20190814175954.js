...
pomBtn.addEventListener('click', setPomTime, setTime(24));
shortBtn.addEventListener('click', setPomTime, setTime(5));
longBtn.addEventListener('click', setPomTime, setTime(10));
showTime();
setBgGreet();
getName();
getFocus();