...
pomBtn.addEventListener('click', setPomTime, {minutes = 24});
shortBtn.addEventListener('click', setPomTime, {minutes = 4});
longBtn.addEventListener('click', setPomTime, {minutes = 9});
showTime();
setBgGreet();
getName();
getFocus();